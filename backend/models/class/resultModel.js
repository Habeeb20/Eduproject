...
const markSchema = new mongoose.Schema({
  ...
  term: { type: String, required: true }, // e.g., 'First Term 2025'
  marks: {
    firstTest: { type: Number, default: 0 },
    secondTest: { type: Number, default: 0 },
    thirdTest: { type: Number, default: 0 },
    midTerm: { type: Number, default: 0 },
    examination: { type: Number, default: 0 },
    total: { type: Number, default: 0 },
    position: { type: Number, default: 0 }, // auto-calculated rank
  },
  autoPosition: { type: Boolean, default: false }, // toggle for ranking
